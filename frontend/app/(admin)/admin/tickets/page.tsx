    ...
    <div className="p-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border p-4 mb-6 flex flex-wrap gap-3">
        <input
          ...
          className="border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 flex-1 min-w-[200px]"
        />
        <select
        ...
        {loading ? (
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                {['Ticket', 'Customer', 'Assigned To', 'Priority', 'Status', 'Created', ''].map(h => (
              ...
              {tickets.map(t => (
                <tr key={t.id} className="hover:bg-gray-50">
                  <td className="px-4 py-3">
                    <div className="text-sm font-medium text-gray-900 max-w-xs truncate">{t.subject}</div>
